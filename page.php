...
<section class="s-content s-content--narrow s-content--no-padding-bottom">
    <article class="row format-standard">
        ...
        <div class="col-full s-content__main">
            ...
            $philosopy_meta = get_post_meta(get_the_ID(), 'my_post_options', true);
            echo esc_html($philosopy_meta['opt-text']) . "<br/>";
            ?>
            <img src="<?php echo  $philosopy_meta['opt-upload-1'] ?>" alt="">
            <?php

            $gallery_opt = $philosopy_meta['opt-gallery-2']; // for eg. 15,50,70,125
            ...
            echo $philosopy_meta['opt-upload-1'] . "<br/>";

            print_r( $philosopy_meta['opt-fieldset-1']) . "<br/>";
            
            if ($philosopy_meta['is_favorite']) {
                echo esc_html($philosopy_meta['favorite_text']) . "<br/>";
            }
            ?>
