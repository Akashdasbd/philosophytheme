    ...
    <section class="s-content s-content--narrow s-content--no-padding-bottom">
        <article class="row format-standard">
            ...
            <div class="col-full s-content__main">
                ...
                $philosopy_get_post_option_data = get_post_meta(get_the_ID(),'my_post_options_for_post',true);


                echo "<pre>";
                 echo ($philosopy_get_post_option_data['opt-sorter-1']);
                echo "</pre>";
                $philosopy_gruop_data_option = $philosopy_get_post_option_data['opt-group-1-me'];



                  foreach ($philosopy_gruop_data_option as $gd) {
                      echo $gd['opt-text'];
                      echo "<br>";
                      echo wp_get_attachment_image($gd['opt-media-1']['id']);
                      echo get_the_title($gd['opt-select-10']);
