...
function cmb2_attached_posts_field_metaboxes_example() {
	...
	$example_meta = new_cmb2_box( array(
		...
		'title'        => __( 'Attached Posts', 'philosopy' ),
	...
	$example_meta->add_field( array(
		'name'    => __( 'Attached Posts', 'philosopy' ),
		'desc'    => __( 'Drag posts from the left column to the right column to attach them to this page.<br />You may rearrange the order of the posts in the right column by dragging and dropping.', 'philosopy' ),
